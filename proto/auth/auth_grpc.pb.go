...
//
// RPC
// protoの型はネットワーク上を流れるので、パスワードはuserに含めない
type AuthServiceClient interface {
	Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*RegisterResponse, error)
	Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error)
	VerifyToken(ctx context.Context, in *VerifyTokenRequest, opts ...grpc.CallOption) (*VerifyTokenResponse, error)
	FindByID(ctx context.Context, in *FindByIDRequest, opts ...grpc.CallOption) (*FindByResponse, error)
}
...
func (c *authServiceClient) FindByID(ctx context.Context, in *FindByIDRequest, opts ...grpc.CallOption) (*FindByResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServiceServer interface {
	...
	FindByID(context.Context, *FindByIDRequest) (*FindByResponse, error)
...
func (UnimplementedAuthServiceServer) FindByID(context.Context, *FindByIDRequest) (*FindByResponse, error) {
