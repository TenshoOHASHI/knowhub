    ...
    >
      ...
      <div className='walking-robot-body shrink-0'>
        <svg
          ...
          height='60'
          viewBox='0 0 120 180'
          className='text-stone-400 dark:text-stone-500 overflow-visible'
        >
          {/* 頭 */}
          <rect
            x='28'
          ...
          <g className={isUp ? 'robot-boost-strong' : 'robot-boost-weak'}>
            ...
            {/* パーティクル（上昇時に大きく飛び散る） */}
            <circle
              className='boost-particle-1'
              cx='48'
              cy='120'
              r={isUp ? 4 : 1.5}
              fill='#fb923c'
              opacity={isUp ? 0.8 : 0.1}
            />
            <circle
              className='boost-particle-2'
              cx='60'
              cy='130'
              r={isUp ? 3.5 : 1}
              fill='#fbbf24'
              opacity={isUp ? 0.7 : 0.08}
            />
            <circle
              className='boost-particle-3'
              cx='72'
              cy='124'
              r={isUp ? 4 : 1.5}
              fill='#fb923c'
