      ...
      <div className='flex items-center justify-between px-5 py-4 border-b border-stone-200 dark:border-stone-700 bg-white/50 dark:bg-stone-800/50 backdrop-blur-sm'>
        <div className='flex items-center gap-3'>
          <div className='relative w-10 h-10'>
            {/* シンプルエレガントな背景 */}
            <div className='absolute inset-0 bg-gradient-to-br from-stone-600 to-stone-700 dark:from-stone-500 dark:to-stone-600 rounded-xl shadow-md' />
            {/* 内側のアイコン */}
            <div className='absolute inset-1 bg-white/10 rounded-lg flex items-center justify-center'>
            ...
            {/* 外側の波紋エフェクト - 小さく調整 */}
            <div className='absolute inset-2 bg-gradient-to-br from-blue-400/40 to-indigo-400/40 dark:from-blue-300/30 dark:to-indigo-300/30 rounded-xl animate-ping' />
          </div>
          <div>
        ...
        {messages.length === 0 && (
          <div className='flex flex-col items-center justify-center h-full text-stone-400 gap-4'>
            ...
            <div className='relative'>
              {/* 吹き出し */}
              <div className='absolute -top-16 left-1/2 -translate-x-1/2 bg-white dark:bg-stone-800 px-4 py-2 rounded-2xl shadow-lg border border-stone-200 dark:border-stone-600 whitespace-nowrap animate-bounce'>
                <p className='text-sm font-medium text-stone-700 dark:text-stone-300'>
                  Ten Botだよ、はじめまして！
                </p>
                {/* 吹き出しの三角部分 */}
                <div className='absolute -bottom-2 left-1/2 -translate-x-1/2 w-0 h-0 border-l-8 border-l-transparent border-r-8 border-r-transparent border-t-8 border-t-white dark:border-t-stone-800' />
              </div>
              {/* ロボット - 近未来風 */}
              <div className='robot-animation'>
                <svg
                  ...
                  height='85'
                  viewBox='0 0 120 110'
                  className='drop-shadow-lg text-stone-400 dark:text-stone-500'
                >
                  {/* 通信エフェクト - 電波 */}
